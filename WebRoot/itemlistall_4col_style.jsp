...
<head>
	...
	<title>ScholarRecSys | Items</title>
		...
		<div class="content-wrapper clearfix">
			...
			<header class="page-header clearfix">
				...
				<ul id="portfolio-filter">
					...
					<li><a data-categories="paper">Papers</a></li>
					<li><a data-categories="book">Books</a></li>
					<li><a data-categories="blog">Blogs</a></li>
					<li><a data-categories="online">Courses</a></li>

				</ul><!-- end #portfolio-items-filter -->
				
			</header><!--/ .page-header-->
			
			<section id="portfolio-items" class="gl-col-4">
				...
				<%
					...
					for(int i=0;i<itemList.size();i++)
					{
						...
						%>
						<article class="one-fourth" data-categories=<%=itemList.get(i).getItemType()%>>
						...
						<a href="<%=basePath+"ItemInfo?itemId="+itemList.get(i).getItemId()%>" class="project-meta">
							<h3 class="title-item"><%=itemList.get(i).getItemType()%>:<%=itemList.get(i).getItemName()%></h3>
						</a>					
			...
			<%
				...
				{%>
					<a href="<%=basePath+"ItemList?pageIndex="+(i-1)%>"><%=i+"  "%></a>
				<%}
			%>			
		</div><!--/ .content-wrapper-->
