	...
	<section class="container">
			...
			<nav id="navigation" class="navigation">
				<ul>
					...
					<li class="current"><a href="pages-about.html">Pages</a>
						<ul>
							<li class="current"><a href="pages-about.html">About Us</a></li>
		...
		<div class="content-wrapper sbr clearfix">
			...
			<div id="content">
				...
				<img class="alignleft" src="images/temp/220px_2.jpg" alt="" />
				
				<p>
					Aenean auctor wisi et urna. Aliquam erat volutpat. Duis ac turpis. Donec sit amet eros. Lorem ipsum dolor sit amet, 
				...
				<p>
					...
					Duis ac turpis. Integer rutrum ante eu lacus. Vestibulum libero nisl, porta vel, scelerisque eget. Vestibulum ante 
				...
				<div class="content-tabs">
					<ul class="tabs-nav clearfix">
						...
						<li><a href="/addpaper_about_style.jsp">Add Paper</a></li>
						<li><a href="/addbook_about_style.jsp">Add Book</a></li>
						<li><a href="/addblog_about_style.jsp">Add Blog</a></li>
						<li><a href="/addcourse_about_style.jsp">Add Course</a></li>
					</ul><!--/ .content-tabs-nav -->
					...
					<div class="tabs-container">
						...
						<div class="tab-content" id="tab1">
							...
							<p>
								In pede mi, aliquet sit amet, euismod in, auctor ut, ligula. Aenean auctor wisi et urna. Aliquam erat volutpat. 
								Duis ac turpis. Donec sit amet eros. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. 
							</p>
						</div><!--/ #tab1-->

						<div class="tab-content" id="tab2">
							<p>
								Morbi vel libero dui, ac elementum velit. Nunc vel nisl vel tortor blandit laoreet. Vestibulum ante ipsum primis
								in faucibus orci luctus et ultrices posuere cubilia Curae; Vestibulum pellentesque odio at erat porttitor
								bibendum ornare sem molestie. Integer dapibus diam tempor lectus iaculis luctus.
							</p>
							<p>
								In pede mi, aliquet sit amet, euismod in, auctor ut, ligula. Aenean auctor wisi et urna. Aliquam erat volutpat. 
								Duis ac turpis. Donec sit amet eros. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. 
