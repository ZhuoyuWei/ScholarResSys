...
<head>
	...
	<title>ScholarRecSys | Paper Info</title>
	...
	<section class="container">
		...
		<div class="content-wrapper sbr clearfix">
			...
			<div class="page-header clearfix">
				...
				<h1 class="alignleft">Paper Information Page</h1>
			...
			<section id="content">
				...
				<article class="post-item clearfix">
    				...
    				for(int i=0;i<item.getAuthorList().size();i++)
    				{
    					...
    					if(i<item.getAuthorList().size()-1)
    					{
    						authorString.append(", ");
    					}
    				}
    			...
    			<!-- <form action="AcceptItem">

					<button type="submit" class="button-style-2 medium">Accept</button>
    			</form>-->
