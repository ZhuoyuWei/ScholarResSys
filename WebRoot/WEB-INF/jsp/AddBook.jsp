...
<html>
  ...
  <body>
    ...
    <div id="add_item_form">
    	<s:form action="AddBookSub">
			<s:hidden name="s_itemType" value="book"/>
    		<s:textfield name="s_itemName" key="Book title"/>
    		<s:textfield name="s_major" key="Major"/>
    		<s:textfield name="s_authorString" key="Authors"></s:textfield>
    		<s:textfield name="s_publisher" key="Publisher"></s:textfield>
