...
<head>
	...
	<title>ScholarRecSys | Add Online Course</title>
...
<div id="wrapper">
	...
	<section class="container">
		...
		<h1 class="content-title">Add An Online Course</h1>
		<form action="AddOnlineCourseSub">
			<input type="hidden" name="s_itemType" value="online"/>
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<label class="input-block" ><input type="text" name="s_itemName" placeholder="Course Name" style="width:200px;"></label>*<br><br>
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp			
			...
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp					
			<label class="input-block"><input type="text" name="s_imageUrl" placeholder="Image" style="width:400px;"></label><br><br>
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp										
			...
			<button type="submit" class="button-style-2 medium">Add Course</button>
    	</form>
