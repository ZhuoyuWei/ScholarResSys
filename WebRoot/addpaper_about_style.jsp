		...
		<div class="content-wrapper sbr clearfix">
			...
			<div id="content">
				...
				<div class="content-tabs">
					<ul class="tabs-nav clearfix" onclick="jump()">
						<li><a href=<%=basePath+"AddPaper"%> onclick="jump()">Add Page</a></li>
						<li><a href=<%=basePath+"AddBook"%> onclick="jump()">Add Book</a></li>
						<li><a href=<%=basePath+"AddBlog"%> onclick="jump()">Add Blog</a></li>
						<li><a href=<%=basePath+"AddOnlineCourse"%> onclick="jump()">Add Course</a></li>	
					</ul><!--/ .content-tabs-nav -->
				</div><!--/ .content-tabs-->
